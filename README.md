...
```
    ...
    tensor[C=3, H=196, W=196] n=115248 (0.4 MiB) x∈[-2.118 |▂▅█▇▂▁▁▂▂▁| 2.640] μ=-0.388 σ=1.073
...
```
    ...
    tensor[3, 196, 196] n=115248 (0.4 MiB) x∈[0. |▃▇▆█▂▁▁▂▃▂| 1.000] μ=0.361 σ=0.248
...
```
    ...
    tensor[128, 49, 49] n=307328 (1.2 MiB) x∈[0. |█▁▁▁▁▁▁▁▁ | 12.508] μ=0.367 σ=0.634 grad (non-leaf) DivBackward0
...
```
    ...
    tensor[2, 2, 2, 3, 196, 196] n=921984 (3.5 MiB) x∈[0. |█▂▂▂▂▂▂▂▂▄| 1.000] μ=0.411 σ=0.369
...
```
    ...
    Parameter[128, 64, 3, 3] n=73728 (0.3 MiB) x∈[-0.783 |  ▁▁██▁▁▁▁| 0.776] μ=-0.004 σ=0.065 grad=None
